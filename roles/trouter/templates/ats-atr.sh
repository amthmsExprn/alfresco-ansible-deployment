...
export JAVA_OPTS="${JAVA_OPTS} -DACTIVEMQ_URL=failover:(tcp://{{ activemq_host_internal }}:61616)?timeout=3000"
export JAVA_OPTS="${JAVA_OPTS} -DFILE_STORE_URL=http://{{ sfs_host_internal }}:8099/alfresco/api/-default-/private/sfs/versions/1/file"
